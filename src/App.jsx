...
// image annotation pot holes
import PotHolesImageaAnnotation from './potHolesImgAnnotation/Task'
    ...
    <>
      ...
      <BrowserRouter>
        ...
        <Routes>
          ...
          {/* image annotation task ( pot holes ) */}
          <Route path='/image-annotatio/pot-holes-task' element={
            <>
              <SignedIn>
                <PotHolesImageaAnnotation></PotHolesImageaAnnotation>
              </SignedIn>
