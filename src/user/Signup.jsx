...
const Signup = () => {
    ...
    const handleSubmit =()=>{
      ...
      try {
        ...
        axios.post("http://localhost:8080/api/signup", {"email" : email , "password" : password} ).then(response=>{
     ...
     <>
         <div className='bg-[#161616] h-screen w-screen flex items-center justify-center flex-col '>
             ...
             <div className='inline-flex flex-col items-center justify-center relative     '>
                ...
                <div className='bg-[#242424]  text-white rounded-[18px] login-div-box-shadow sm:w-[500px] '>
